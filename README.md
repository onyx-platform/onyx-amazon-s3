...
```clojure
[org.onyxplatform/onyx-amazon-s3 "0.12.0.0-SNAPSHOT"]
```
...
|`:s3/prefix-key-separator`             | `string`  | A separator to add after `:s3/prefix` and before the result of `:s3/key-naming-fn`. Defaults to "/".
